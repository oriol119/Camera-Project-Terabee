    ...
    def run(self):
        ...
        while(True):
            ...
            for i in valor_complert:
                ...
                frame_thread_ok = frame_thread.get_buffer_as_uint16()
                frame_thread_resize = np.asarray(frame_thread_ok).reshape((60, 80)) #* depth_correction
                #frame_thread_color = cv2.applyColorMap(frame_thread_resize.astype(np.uint8), cv2.COLORMAP_JET)
                ...
                if i == 0:
                    ...
                    #aMedian_blur = cv2.medianBlur(frame_thread_color, 3)
                    aTotal = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("0")
                elif i == 1:
                    a1 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("2n:")
                    #print(a1[30][30])
                    aTotal = (aTotal + a1)/2
                    ...
                    a2 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a2[30][30])
                    aTotal = (aTotal + a2)/2
                    #print("2")
                    ...
                    a3 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a3[30][30])
                    aTotal = (aTotal + a3)/2
                    #print("3")
                    ...
                    global a_intervals
                    a4 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a4[30][30])
                    aTotal = (aTotal + a4)/2
                    #print("4")
                    ...
                    a5 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a5[30][30])
                    aTotal = (aTotal + a5)/2
                    #print("5")
                    ...
                    a6 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a6[30][30])
                    aTotal = (aTotal + a6)/2
                    #print("6")
                    ...
                    a7 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a7[30][30])
                    aTotal = (aTotal + a7)/2
                    #print("7")
                    ...
                    a8 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a8[30][30])
                    aTotal = (aTotal + a8)/2
                    #print("8")
                    ...
                    a9 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a9[30][30])
                    aTotal = (aTotal + a9)/2
                    #print("9")
                    ...
                    a10 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a10[30][30])
                    aTotal = (aTotal + a10)/2
                    #print("10")
                    ...
                    a11 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a11[30][30])
                    aTotal = (aTotal + a11)/2
                    #print("11")
                    ...
                    a12 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a12[30][30])
                    aTotal = (aTotal + a12)/2
                    #print("12")
                    ...
                    a13 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a13[30][30])
                    aTotal = (aTotal + a13)/2
                    #print("13")
                    ...
                    a14 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a14[30][30])
                    aTotal = (aTotal + a14)/2
                    #print("14")
                    ...
                    a15 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a15[30][30])
                    aTotal = (aTotal + a15)/2
                    #print("15")
                    ...
                    a16 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a16[30][30])
                    aTotal = (aTotal + a16)/2
                    #print("16")
                    ...
                    a17 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a17[30][30])
                    aTotal = (aTotal + a17)/2
                    #print("17")
                    ...
                    a18 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a18[30][30])
                    aTotal = (aTotal + a18)/2
                    #print("18")
                    ...
                    a19 = np.asarray(frame_thread_ok).reshape((60, 80))
                    #print("3r:")
                    #print(a19[30][30])
                    aTotal = (aTotal + a19)/2
                    #print("19")
...
while not done and cv2.getWindowProperty("Filtered", cv2.WND_PROP_FULLSCREEN) != -1:
    ...
    #blur = cv2.applyColorMap(aTotal.astype(np.uint8), cv2.COLORMAP_JET)
    #final = cv2.medianBlur(blur, 3) 
    #final_ok = cv2.resize(final, (800, 500), interpolation=cv2.INTER_LINEAR)
    #cv2.imshow("MEDIAN BLUR", final_ok) 


    #dst = cv2.fastNlMeansDenoising(mitja,None,3,7,21)
    #dst_ok = cv2.resize(dst, (800, 500), interpolation=cv2.INTER_LINEAR)
    #cv2.imshow("DENOISING", dst_ok) 
    ...
    if contador == 1:
        ...
        static_frame_color[np.where(frame_fons > 558)] = [255,0,0]
        ...
        oscilacio = aTotal[30][40] - frame_fons[30][40]
        #print(oscilacio, frame_thread_resize[30][40] )
        


        resta_1 = aTotal - frame_fons - oscilacio
        #resta_2 = final - static_frame_color
        ...
        resta1[np.where(resta_1 > -6)] = [255,255,255] #blanc
        ...
        #        if y== 0 or x==0:
        #            resta1[y][x] = [255,255,255]
                


        #        elif all(resta1[y-1][x] == [255, 255, 255]) and all(resta1[y+1][x] == [255, 255, 255]) and all(resta1[y][x+1] == [255, 255, 255]) and all(resta1[y][x-1] == [255, 255, 255] ):

        #            resta1[y][x] = [255,255,255]

         #       elif all(resta1[y-1][x] == [255, 255, 255]) and all(resta1[y+1][x] == [255, 255, 255]) and all(resta1[y][x+1] == [255, 255, 255]):
        ...
        #        elif all(resta1[y-1][x] == [255, 255, 255]) and all(resta1[y][x+1] == [255, 255, 255]) and all(resta1[y][x-1] == [255, 255, 255] ):
        ...
        #resta_filtre = cv2.resize(resta1, (800, 500), interpolation=cv2.INTER_LINEAR)

        #cv2.imshow("RESTA_FILTRE", resta_filtre) 
    

 
        #frame_intervals = cv2.applyColorMap(a_intervals.astype(np.uint8), cv2.COLORMAP_JET)
        #frame_intervals_ok = cv2.resize(frame_intervals, (800, 500), interpolation=cv2.INTER_LINEAR)
        #cv2.imshow("INTERVALS", frame_intervals_ok) 
